      ...
      <div className="bg-gray-100">
        <div className="flex flex-col h-screen">
          ...
          <div className="container flex items-center justify-center flex-col rounded-2xl w-1/3 h-full bg-white shadow-xl mx-2 mt-4">
              ...
              <p>
                <a className="text-base text-center font-bold m-3 text-blue-900 hover:text-blue-700" href = "https://www.linkedin.com/in/cesaralansilva/">Omar Michel Carmona Villalobos</a><br/> 
                <a className="text-base text-center font-bold m-3 text-blue-900 hover:text-blue-700" href = "https://www.linkedin.com/in/cesaralansilva/">Miguel Ángel Barrientos Ballesteros</a><br/>
                <a className="text-base text-center font-bold m-3 text-blue-900 hover:text-blue-700" href = "https://www.linkedin.com/in/cesaralansilva/">Cesar Alán Silva Ramos</a><br/>
                <a className="text-base text-center font-bold m-3 text-blue-900 hover:text-blue-700" href = "https://www.linkedin.com/in/juli%C3%A1n-enrique-espinoza-valenzuela-a145a2287/">Julian Enrique Espinoza Valenzuela</a><br/>
                <a className="text-base text-center font-bold m-3 text-blue-900 hover:text-blue-700" href = "https://www.linkedin.com/in/cesaralansilva/">Gabriel Alvarez Arzate</a></p>  
          </div>
          {/* White box */}
          <div className="container flex items-center justify-center flex-col rounded-2xl w-1/3 h-full bg-white shadow-xl mx-2 mt-4">
          ...
          <div className="container flex items-center justify-center flex-col rounded-2xl w-1/3 h-full bg-white shadow-xl mx-2 mt-4">
            ...
            <p className="text-base text-center font-bold m-3">Omar Michel Carmona Villalobos |<span className = "text-blue-900"> A01644146</span><br/> 
