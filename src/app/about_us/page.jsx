    ...
    <div className="bg-gray-100">
      <div className="flex flex-col items-center justify-center h-screen">
        ...
        <div className="container flex items-center justify-center flex-col rounded-2xl w-1/8 h-1/4 bg-white shadow-xl ">
            <p className="text-2xl text-center font-bold">Our main goal is to change how education works by using smart AI to give each student a personalized learning journey. With the Feynman Method at the heart of what we do, we help students really understand complex topics. Our platform gives feedback and suggests materials that fit each student's unique learning style. Our aim is to help students learn better and love learning for life, making education more enjoyable and effective for everyone.</p>
        </div>
